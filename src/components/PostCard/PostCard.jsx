...
const PostCard = (props) => {
  ...
  const handleDelete = async (postid, userid) => {
    const res = await axios({
      url: `https://rezzit-backend.onrender.com/post/${postid}/deletepost`,
      method: "delete",
      data: {
        userId: userid,
      },
  ...
  return (
    <div className="postCard">
      {/* <ShareModel modalOpened={modalOpen} setmodalOpen={setmodalOpen} /> */}
      <ShareModel
        modalOpen={modalOpen}
      ...
      <div className="detail">
        ...
        <div onClick={() => handleDelete(data._id, user._id)}>
          <svg
            xmlns="http://www.w3.org/2000/svg"
            fill="none"
            viewBox="0 0 24 24"
